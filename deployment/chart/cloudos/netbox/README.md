...
```shell
$ helm repo add pkg-helm-local https://anselmes.jfrog.io/artifactory/helm/pkg-helm-local
$ helm install netbox \
...
```shell
$ helm install --name my-release pkg-helm-local/netbox --values values.yaml
```
